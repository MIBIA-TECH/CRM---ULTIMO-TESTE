...
const UpdateWhatsAppService = async ({
  ...
  await whatsapp.update({
    ...
    maxUseInactiveTime,
    color,
    phone_number_id: phone_number_id !== undefined ? phone_number_id : whatsapp.phone_number_id,
    waba_id: waba_id !== undefined ? waba_id : whatsapp.waba_id,
    send_token: send_token !== undefined ? send_token : whatsapp.send_token,
    business_id: business_id !== undefined ? business_id : whatsapp.business_id,
    phone_number: phone_number !== undefined ? phone_number : whatsapp.phone_number,
    waba_webhook: whatsapp.waba_webhook,
    waba_webhook_id: whatsapp.waba_webhook_id,
    timeToReturnQueue,
    timeAwaitActiveFlowId,
    timeAwaitActiveFlow,
    triggerIntegrationOnClose
